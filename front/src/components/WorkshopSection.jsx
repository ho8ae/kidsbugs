  ...
  const workshops = [
    {
      title: '곤충 생태 교실',
      description:
        '전문 곤충학자와 함께 다양한 곤충의 생태와 특성에 대해 배우는 교육 프로그램입니다. 현미경 관찰 및 실습을 통해 곤충의 신비로운 세계를 탐험해보세요.',
      schedule: '토요일, 일요일',
      ageGroup: '5-10세',
      image: '/logo/KIDSBUGSlogo.png', // 체험학습 이미지
      tags: ['교육', '관찰', '체험'],
    },
    {
      title: '곤충 사육 체험',
      description:
        '직접 애완곤충을 돌보고 관리하는 방법을 배우는 체험 프로그램입니다. 사육장 꾸미기부터 먹이주기까지, 곤충과 함께하는 특별한 시간을 경험해보세요.',
      schedule: '수요일, 금요일',
      ageGroup: '7-13세',
      image: '/logo/KIDSBUGSlogo.png', // 체험학습 이미지
      tags: ['사육', '케어', '관리'],
          ...
          <div ref={titleRef}>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <div className="title-line">
                <span className="highlight text-green-600">체험학습</span>으로
                배우는
              </div>
              <div className="title-line">자연의 신비</div>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto title-line">
              곤충과 함께하는 특별한 교육 프로그램으로 아이들의 호기심을
              자극하세요
            </p>
          </div>
        </div>
          ...
          {workshops.map((workshop, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <h3 className="workshop-title text-xl font-semibold mb-3">
                  {workshop.title}
                </h3>
                <p className="workshop-desc text-gray-600 mb-5">
